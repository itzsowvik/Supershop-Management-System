...
{
    public partial class OwnerAddProduct : Form
    {
        BusinessLayer bl = new BusinessLayer();
        public OwnerAddProduct()
        {
            InitializeComponent();
        }

        private void OwnerAddProduct_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }

        private void OwnerAddProduct_Load(object sender, EventArgs e)
        {
        ...
        {
            if(bl.TextCheck(prodname_textbox.Text)&& bl.EmptyCheck(prodname_textbox.Text))
            {
