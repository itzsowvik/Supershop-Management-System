...
{
    public partial class ManagerDepreciation : Form
    {

        BusinessLayer bl = new BusinessLayer();
        int propertyId = 1004;

        public ManagerDepreciation()
        {
            InitializeComponent();
        }

        private void AllDepreciation_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }

        private void AllDepreciation_Load(object sender, EventArgs e)
        {
